  ...
  return (
    <div className="min-h-screen bg-transparent text-zinc-100 flex flex-col justify-center items-center px-4 py-10 relative overflow-hidden font-sans select-none">
      <div className="w-full max-w-lg relative z-10 space-y-6">
        ...
        {/* Main Card */}
        <div className="p-6 sm:p-8 rounded-[28px] bg-[#121c1a]/70 backdrop-blur-2xl border border-white/[0.09] ring-1 ring-white/[0.05] shadow-[0_25px_60px_rgba(0,0,0,0.7)] space-y-6 relative overflow-hidden">
